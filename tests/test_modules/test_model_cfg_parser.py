...
@pytest.fixture()
def bad_config_1():
    bad_config1 = basic_model_cfg_parsing("example_models_for_tests/configs/bad_config1.cfg")
    yield bad_config1
    print('something')
...
@pytest.fixture()
def bad_config_2():
    bad_config2 = basic_model_cfg_parsing("example_models_for_tests/configs/bad_config2.cfg")
    yield bad_config2
